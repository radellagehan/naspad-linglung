...
public class BuyerDashboard extends JFrame {
    ...
    public BuyerDashboard(int userId) {
        this.userId = userId;
        setTitle("MinangLuxe — Buyer Dashboard (ID: " + userId + ")");
        ...
        BuyerPanel buyerPanel = new BuyerPanel(userId);
        ...
        JSplitPane mainSplit = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, buyerCol, recCol);
        mainSplit.setResizeWeight(0.67);
        mainSplit.setDividerSize(4);
        mainSplit.setBackground(com.minangluxe.tender.util.StyleUtil.BG_DARK);
    ...
    private JPanel createTopBar() {
        ...
        JLabel logo = new JLabel("♦ MinangLuxe Buyer");
